...
function onLoad(assignmentId, ownerName, version, edLink) {
  ...
  header.append($('<p>').append("All written answers must be <b>typeset (preferably in LaTeX)</b>. We strongly recommend using Overleaf. A link to a tex file with prompts can be found on Ed."));
