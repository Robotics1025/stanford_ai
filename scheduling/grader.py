...
grader.add_manual_part('1a', 5, description="Define light bulb CSP")
grader.add_manual_part('1b', 5, description="Solving the CSP")

############################################################
# Problem 1c: Simple Chain CSP
...
grader.add_basic_part('1c-1-basic', test1c, 2, max_seconds=1,
...
grader.add_basic_part('2a-1-basic', test2a_1, 2, max_seconds=1,
...
grader.add_hidden_part('2a-3-hidden', test2a_3, 1, max_seconds=1,
...
grader.add_basic_part('3a-1-basic', test3a_1, 2, max_seconds=4,
...
grader.add_hidden_part('3a-2-hidden', test3a_2, 2, max_seconds=3,
...
grader.add_hidden_part('3a-3-hidden', test3a_3, 2, max_seconds=3,
...
grader.add_basic_part('3b-1-basic', test3b_1, 3, max_seconds=7,
...
grader.add_hidden_part('3b-2-hidden', test3b_2, 3, max_seconds=3,
...
grader.add_hidden_part('3b-3-hidden', test3b_3, 1, max_seconds=4,
...
grader.add_hidden_part('3b-4-hidden', test3b_4, 3, max_seconds=25,
        description="Test MVC+AC-3+all additional constraints")

grader.add_manual_part('3c', 2, description="Your own schedule")

############################################################
# Problem 4a

grader.add_manual_part('4a', 2, description="Residency Hours Scheduling")
